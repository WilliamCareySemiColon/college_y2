...
insert into event (eventID, eventName, eventDate, sportCode) values (4, '200m Mens Final', '18 AUG 2016', 1);
insert into event (eventID, eventName, eventDate, sportCode) values (5, '200m Womens Final', '17 AUG 2016', 1);
...
insert into EventEnrollment (eventID, compID, position) values (4, 1, 1);
insert into EventEnrollment (eventID, compID, position) VALUES (4, 3, 2);
insert into EventEnrollment (eventID, compID, position) VALUES (4, 10, 3);
insert into EventEnrollment (eventID, compID, position) VALUES (5, 4, 1);
insert into EventEnrollment (eventID, compID, position) VALUES (5, 11, 2);
insert into EventEnrollment (eventID, compID, position) VALUES (5, 5, 3);
