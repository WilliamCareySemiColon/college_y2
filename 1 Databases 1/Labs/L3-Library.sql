...
-- Select statements
SELECT  *  FROM  BOOK;
--describing the contents of the books
describe BOOK;
--select the firstname,lastname and street address
SELECT FIRST_NAME "First Name", LAST_NAME "Last Name",STREET_ADDRESS "Street Address" from BORROWER;
--using the transaction sector
SELECT TRANSACTIONID, BORROWERID, BOOKID, TRANSACTION_DATE, TRANSACTION_TYPE from Transaction where TRANSACTION_TYPE BETWEEN 1 AND 2;
-- projection
